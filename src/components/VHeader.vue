          ...
          <div class="collapse navbar-collapse">
            ...
            <div class="navbar-action">
              <div class="navbar-search" :class="{active}">
                <input ref="search" type="text" class="navbar-search-input" autocomplete="off" placeholder="输入关键词搜索..." v-model="keyWord" @keyup.enter="search" @blur="showSearchPanel(false)">
...
export default {
  ...
  computed: {
    ...mapState(['user']),
    headBg() {
      let bgList = ['url(/static/img/banner/advbanner_bg_01.png)', 'url(/static/img/s1.jpg)', 'url(/static/img/s2.jpg)', 'url(/static/img/s3.jpg)']
      return bgList[this.curIdx.header];
    },
    menuBg(){
  ...
  methods: {
    ...
    nextTheme(idx) {
      switch (idx) {
        case 1:
          this.$store.commit('setThemeHeader',(this.curIdx.header + 1) % 4);
          break;
        case 2:
